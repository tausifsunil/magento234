...
return [
    'modules' => [
        ...
        'Amazon_Login' => 1,
        'Amazon_Payment' => 1,
        'BkFootware_Newsletter' => 0,
        'Dotdigitalgroup_Email' => 0,
        'Dotdigitalgroup_Chat' => 0,
        'Forever_AuthenticationPopUp' => 0,
        'Forever_BannerSlider' => 0,
        'Forever_BestSeller' => 0,
        'Forever_Blog' => 0,
        'Forever_Brand' => 0,
        'Forever_Core' => 0,
        'Forever_Dailydeals' => 0,
        'Forever_Faq' => 0,
        'Forever_InfiniteScroll' => 0,
        'Forever_LayeredNavigation' => 0,
        'Forever_Lazyload' => 0,
        'Forever_Map' => 0,
        'Forever_Megamenu' => 0,
        'Forever_NewArrival' => 0,
        'Forever_NewsletterPopup' => 0,
        'Forever_Onestep' => 0,
        'Forever_Productlabel' => 0,
        'Forever_Productzoom' => 0,
        'Forever_QuickView' => 0,
        'Forever_StoreLocator' => 0,
        'Forever_Team' => 0,
        'Forever_Testimonials' => 0,
        'Ict_Customerprice' => 0,
        'Ict_Orderdelete' => 0,
        'Ict_Shopbybrand' => 0,
        'Klarna_Core' => 1,
